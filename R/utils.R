...
##'   Generic function for the following input classes: integer,
##'   numeric, character and Date. For an easy way to produce a
##'   specific date a string ala "20140101" can be provided.
##'
